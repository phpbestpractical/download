                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">ADD Ads Type</h3></div>
                                    <div class="panel-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="<?php echo base_url('admin/ads/add');?>" novalidate="novalidate">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-10">
                                                        ...
                                                        <a class="btn btn-purple waves-effect" href="<?php echo base_url('admin/ads');?>">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- .form -->
