                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">EDIT ACCOUNT</h3></div>
                                    <div class="panel-body">
                                        <div class="form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="<?php echo base_url('admin/account/edit/'.$id);?>" novalidate="novalidate">
                                                <div class="form-group">
                                                    <label for="cname" class="control-label col-lg-2">Account Name</label>
                                                    <div class="col-lg-5">
                                                        <input class="form-control" id="name" name="name" value="<?php echo $AccountName?>" type="text" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-10">
                                                        ...
                                                        <a class="btn btn-purple waves-effect" href="<?php echo base_url('admin/account');?>">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- .form -->
